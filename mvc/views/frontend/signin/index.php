<?php
    ...
    // Tạo mới một lớp đói tượng redirect (chứa phương thức liên quan đến việc chuyển hướng trang)
...
<body class="login">
    <div>
        <!-- Khai báo 2 liên kết ẩn -->
        <a class="hiddenanchor" id="signup"></a>
        <a class="hiddenanchor" id="signin"></a>

        <div class="login_wrapper">
            <!-- Kiểm tra xem sesstion flash có hay không? Nếu đúng thì trả về flash với class là text-success còn nếu sai trả về errors với class là text-danger -->
