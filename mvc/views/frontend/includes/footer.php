...
?>
<section class="footer" style="background:#4f4f4f">
    <div class="container">
        <div class="list_items">
            <div class="item">
                <h3>ECOMMERCE</h3>
                <div class="info__company">
                    <p style="color:white;"><strong>Website:</strong><a style="color:white;" href="QHC.COM/">QHC.COM</a></p>
                    <p style="color:white;"><strong>Địa chỉ:</strong>HCM CITY</p>
                    <p style="color:white;"><strong>Số điện thoại:</strong><a style="color:white;" href="tel:090xxxxxxx">+123 456 789</a></p>
                </div>
            </div>
            <div class="item" style="color:white;">
                <h3>Danh mục sản phẩm</h3>
                <ul>
                    <li><a style="color:white;" href="">Iphone</a></li>
                    <li><a style="color:white;" href="">SamSung</a></li>
                    <li><a style="color:white;" href="">Xiaomi</a></li>
                </ul>
            </div>
            <div class="item" style="color:white;">
                <h3>Chính sách</h3>
                <ul>
                    <li><a style="color:white;" href="">Chính sách mua hàng</a></li>
                    <li><a style="color:white;" href="">Chính sách đổi trả</a></li>
                </ul>
            </div>
            <div class="item" style="color:white;">
                <h3>Bài viết</h3>
                <ul>
                    <li><a style="color:white;" href="">Công nghệ</a></li>
                    <li><a style="color:white;" href="">Kỹ thuật</a></li>
                </ul>
            </div>
        </div>
    </div>
